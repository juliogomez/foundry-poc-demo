...
- **Run:** `run_2f61b23de3ec`
- **Target:** `langflow` @ `1.7.3`
- **Model:** `claude-sonnet-4-6`  |  **Backend:** `cursor`
- **Units analyzed:** 107  |  **Candidates:** 15  |  **Tokens:** 848819/1500000
- **Stop reason:** coverage-complete (all 107 units); trailing true-positive yield=0.17
...
## 11. startswith prefix bypass is not reachable given prior allowlist controls  
...
## 12. Refresh token in cookie is itself the credential; no missing auth  
**Verdict:** `false-positive`  |  **Severity:** `none`  |  **Class:** CWE-862  |  **Rule:** `codeguard-py-missing-authz`
...
## 13. ORM getattr column selection is not SQL injection  
...
## 14. ORM getattr column selection is not SQL injection  
**Verdict:** `false-positive`  |  **Severity:** `none`  |  **Class:** CWE-89  |  **Rule:** `EXPLORATORY`
